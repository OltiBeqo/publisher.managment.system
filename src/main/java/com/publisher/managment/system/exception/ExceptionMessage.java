...
public class ExceptionMessage {
    protected static final String USER_NOT_FOUND = "User %s with id %d not found";
    protected static final String ROLE_NOT_FOUND = "User %s with role %d not found";
    protected static final String USERNAME_EXISTS = "%s with this %s : %s already exists";
    protected static final String BOOK_TITLE_FOUND = "Book with title %s not found";
    protected static final String BOOK_NOT_FOUND = "Book with id %s not found";
